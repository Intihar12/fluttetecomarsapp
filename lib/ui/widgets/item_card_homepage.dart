...
import 'item_card_category_product.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            product.itemsPerUnit! + " " + product.unit!,
                                        ...
                                        for (int i = 0;
                                            i <
                                                categoryController
                                                    .subCatModel!.length;
                                            i++) {
                                          if (categoryController.subCatModel![i]
                                                  .products!.length !=
                                              0) {
                                            for (int k = 0;
                                                k <
